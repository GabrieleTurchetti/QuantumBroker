...
class IonQBackend(Backend):
    ...
    def __init__(
        ...
        self._noise_model = noise_model if noise_model is not None else "ideal"
    ...
    def process_circuits(
        ...
        **kwargs: KwargTypes,
        ...
        basebody: dict = {
            ...
            "noise": {"model": self._noise_model},
        } #ATTENTION: noise model here! (https://ionq.com/docs/get-started-with-hardware-noise-model-simulation)
        handles = []
